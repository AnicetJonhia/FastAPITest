...
def assign_onboarding_for_user(db: Session, user):
    """
    Create checklist items for the user from department templates and RH global templates.
    For simplicity: templates are ChecklistItem entries with user_id=None.
    """
    # Global templates (department_id is None)
    ...
    # For transparency, also return relevant documents
